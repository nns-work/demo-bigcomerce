...
class TruAcousticsWindowHelper {
  constructor() {
    ...
    this._getOptions()
      .then((result) => {
        /* eslint-disable */console.log(...oo_oo(`240200895_56_8_56_31_4`,{ result }));
      });
  }
  ...
  _getWindowSquareFeet() {
    ...
    return Math.ceil(inchesToFeet(this._value.dimensionsWidth) * inchesToFeet(this._value.dimensionsHeight));
  }
    ...
    return fetch('https://www.secondskinaudio.com/graphql', options)
      ...
      .then(resp => {
        ...
        return products[0].node.productOptions.edges.reduce((acc, val) => {
          ...
          /* eslint-disable */console.log(...oo_oo(`240200895_274_10_274_30_4`,{ val }));
  ...
  _getTruAcousticsWindow(productId, optionValueIds) {
    ...
    return fetch('https://www.secondskinaudio.com/graphql', options)
      .then(resp => resp.json())
      .then((resp) => {
        /* eslint-disable */console.log(...oo_oo(`240200895_326_8_326_37_4`,{ foobar: resp }));
